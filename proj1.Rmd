...
ggplot(dat, aes(Environment, Road_Surface)) + geom_tile(aes(fill = Rescale), color = "white") + scale_fill_gradient(low="white", high = "steelblue") + theme(axis.text.x = element_text(angle = 20, hjust = 1))
```
